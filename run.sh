...
python train.py --dataset reddit --sample_method ladies --cuda
...
python train.py --dataset reddit --sample_method fastgcn --cuda 
...
python train.py --dataset reddit --sample_method graphsage --cuda
...
# python train.py --dataset reddit --sample_method graphsaint --cuda
# python train.py --dataset yelp --sample_method graphsaint --cuda -1

python train.py --dataset ppi --sample_method exact
python train.py --dataset ppi-large --sample_method exact 
python train.py --dataset reddit --sample_method exact